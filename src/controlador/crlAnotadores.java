 ...
 * @author Gudelia
 */
public class crlAnotadores implements  ActionListener, MouseListener  {
    
    private anotadores modelo;
    private frmAnotadores vista;
    
    
    
    //8-crear constructor
    
    public crlAnotadores( anotadores modelo, frmAnotadores vista){
    this.modelo = modelo;
    this.vista = vista;
...
if (e.getSource() == vista.btnEquiposF2) {
    ...
    modelo.mostrarAnotaciones(vista.jtAnotadores); // Actualizar tabla de anotaciones
}
