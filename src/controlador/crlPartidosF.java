 ...
 * @author Gudelia
 */
public class crlPartidosF  implements  ActionListener, MouseListener{
    private PartidosA modelo;
    private frmPartidosF vista;
    
    //8-crear constructor
    
    public crlPartidosF( PartidosA modelo, frmPartidosF vista){
    this.modelo = modelo;
    this.vista = vista;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (confirmation == JOptionPane.YES_OPTION) {
            modelo.resetearEstadisticasEquipos();// Llamar al método para borrar las anotaciones
        ...
        if (e.getSource() == vista.cbEquipo1) {
            String seleccionado = vista.cbEquipo1.getSelectedItem().toString();
            System.out.println("Equipo seleccionado: " + seleccionado);
        }
        
        if (e.getSource() == vista.cbEquipo2) {
            String seleccionado = vista.cbEquipo2.getSelectedItem().toString();
            System.out.println("Equipo seleccionado: " + seleccionado);
        }
        
        if (e.getSource() == vista.cbTorneos) {
            String seleccionado = vista.cbTorneos.getSelectedItem().toString();
            System.out.println("Equipo seleccionado: " + seleccionado);
        ...
        if (e.getSource() == vista.btnExcel) {
            ...
            frmTablaFut frmTablaFut = new frmTablaFut();
            frmTablaFut.initFrmFut();
...
if (e.getSource() == vista.btnEquiposF2) {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        // Llamar al modelo para actualizar goles y estadísticas
        modelo.actualizarGolesYEstadisticas(idPartido, golesEquipo1, golesEquipo2);
