...
public class fut {
    ...
    modeloDeDatos.setColumnIdentifiers(new Object[]{
        ...
        "Juegos Empatados", "Goles a Favor", "Goles en Contra", "Promedio", "Total Puntos"
    });

    try {
        // Consulta SQL para obtener los equipos de fútbol
        String sql = "SELECT idEquipo, nombreEquipo, juegosJugados, juegosGanados, juegosPerdidos, " +
                     "juegosEmpatados, golesAFavor, golesEnContra, avarage, totalPuntos " +
                     "FROM tbEquiposFut";
     ...
     public List<Object[]> obtenerDatosDeTabla() throws SQLException {
        ...
        String query = "SELECT * FROM tbEquiposFut"; // Reemplaza "tu_tabla" con el nombre de tu tabla
    ...
    public void exportarTablaAExcel(JTable tabla) {
        try {
            ...
            String filePath = "C:\\Users\\Gudelia\\Documents\\tabla_datos.xlsx";  // Cambia la ruta según sea necesario
