...
import controlador.crlPartidosB;
 ...
 * @author Gudelia
 */
public class frmPartidosB extends javax.swing.JFrame {

    /**
     * Creates new form frmPartidosB
     */
    public frmPartidosB() {
        initComponents();
...
//diseno
     ...
     */
     public static void initFrmPartidosB() {
        PartidosB modelo = new PartidosB();
        frmPartidosB vista = new frmPartidosB();
        crlPartidosB controlador = new crlPartidosB(modelo, vista);
    ...
    private void initComponents() {
        ...
        jPanel1.add(cbTorneos, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 590, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, 1040, 430));
        ...
        jLabel15.setText("Administracion de Partidos Basketbol");
        ...
        jPanel6.add(golesEquipo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 110, 50));
        ...
        jPanel6.add(golesEquipo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 90, 110, 50));

        jLabel10.setText("Equipo2");
        jPanel6.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 70, -1, -1));

        btnActualizarGoles.setText("jButton1");
        jPanel6.add(btnActualizarGoles, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, 110, 40));

        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 30, 300, 150));

        btnBorrarAnotaciones.setText("Reiniciar Estadisticas");
        jPanel1.add(btnBorrarAnotaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 650, 170, 30));

        btnExcel.setText("jButton1");
        jPanel1.add(btnExcel, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 160, 160, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPartidosB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
