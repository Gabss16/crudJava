...
import controlador.crlAnotadores;
...
import modelo.anotadores;

/**
 *
 * @author Gudelia
 */
public class frmAnotadores extends javax.swing.JFrame {

    /**
     * Creates new form frmAnotadores
     */
    public frmAnotadores() {
        initComponents();
...
//diseno
     ...
     */
     ...
     public static void initFrmAnotadores() {
        anotadores modelo = new anotadores();
        frmAnotadores vista = new frmAnotadores();
        crlAnotadores controlador = new crlAnotadores(modelo, vista);
    ...
    private void initComponents() {
        ...
        jPanel1.add(cbAnotador, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 420, 40));
        ...
        jLabel15.setText("Bitacora de Puntos ASOB");
        ...
        jPanel1.add(btnInsertar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 130, 130, 40));
        ...
        jLabel9.setText("Cant. de puntos:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAnotadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
