...
btnAgregar.setFont(new Font("Arial", Font.PLAIN, 12)); // Estilo de fuente
     ...
     */
     public static void initFrmEquipos() {
        equipos modelo = new equipos();
        frmEquipos vista = new frmEquipos();
        crlEquipos controlador = new crlEquipos(modelo, vista);
    ...
    private void initComponents() {
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 300, 420));
        ...
        jPanel6.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 680, 400));

        btnEliminarJugador.setText("Eliminar");
        jPanel6.add(btnEliminarJugador, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 30, 80, 40));
        ...
        jPanel6.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 80, 220, 40));
        ...
        jPanel6.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 10, -1, -1));
        ...
        jLabel14.setText("Gestión de Equipos Basketbol ASOB");
        ...
        jPanel3.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 210, 140, 40));

        btmEliminar.setBackground(new java.awt.Color(51, 51, 51));
        btmEliminar.setText("Eliminar");
        jPanel3.add(btmEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 210, 90, 40));
