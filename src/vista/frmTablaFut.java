 ...
 * @author Gudelia
 */
public class frmTablaFut extends javax.swing.JFrame {

    /**
     * Creates new form frmTablaFut
     */
    public frmTablaFut() {
        initComponents();
    ...
    public static void initFrmFut() {
        fut modelo = new fut();
        frmTablaFut vista = new frmTablaFut();
        crlfut controlador = new crlfut(modelo, vista);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, 0, 990, 550));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTablaFut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
